...
<img src="https://www.google.com/search?q=https://socialify.git.ci/agonie0v0/netcup-monitor/image%3Fdescription%3D1%26font%3DInter%26language%3D1%26name%3D1%26owner%3D1%26pattern%3DCircuit%2520Board%26theme%3DAuto" alt="Netcup Monitor Pro" width="640" height="320" />

📊 Netcup Monitor Pro

专为 Netcup RS/VPS 打造的智能化流量监控与自动化流控面板

功能特性 • 工作原理 • 部署指南 • 配置详解 • 常见问题
...
services:
  netcup-monitor:
    ...
    environment:
      - TZ=Asia/Shanghai
      # - SECRET_KEY=your_secret_key  # 可选：用于 Session 加密
...
不托管 (Unmanaged)：开启后，脚本只监控流量和状态，不执行任何删除、暂停操作。
...
数据安全：本项目涉及对 qBittorrent 种子的 删除 操作。请务必正确配置 “保留分类” 及 “不托管” 选项。

账号安全：Netcup 账号密码存储在你的服务器本地，请确保服务器安全。

责任界定：作者不对因配置错误导致的数据丢失或账号问题负责。
